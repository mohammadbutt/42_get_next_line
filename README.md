...
Flag has the following access modes: O_RDONLLY, O_WRONLY, O_RDWR. O_RDONLY stands for read only. O_WRONLY stands for write only. O_RDWR stands for read/write.
